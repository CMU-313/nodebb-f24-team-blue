...
module.exports = function (Categories) {
	...
	Categories.searchTopics = async function (data) {
		// Extract these three fields from the data object
		...
		if (searchTerm) {
			...
			for (const key of keys) {
				// Generated by ChatGPT to search for topics with the given search term
				try {
	...
	Categories.anonymousTopics = async function (data) {
		...
		for (const key of keys) {
			try {
				...
				console.log(`Error fetching anonymous topics for category ${cid}`);
			}
		}
